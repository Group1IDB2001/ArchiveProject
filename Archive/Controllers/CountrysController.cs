...
namespace Archive.Controllers
{
    public class CountrysController : Controller
    {
        ...
        //[HttpPut]
        //[Route("countrys/name/{id:int}")]
        //public async Task EditAuthorAbout(int id, [FromBody] CreateCountryRequest request) => await _manager.EditCountryName(id, request.Name);
