    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Qestiones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Qestiones_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemLanguages_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reactions_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Saves_Collections_CollectionId",
                        column: x => x.CollectionId,
                        principalTable: "Collections",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Responses_Collections_CollectionId",
                        column: x => x.CollectionId,
                        principalTable: "Collections",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Responses_Qestiones_QestionId",
                        column: x => x.QestionId,
                        principalTable: "Qestiones",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemLanguages_ItemId",
                table: "ItemLanguages",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemLanguages_LanguageId",
                table: "ItemLanguages",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Qestiones_UserId",
                table: "Qestiones",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Reactions_ItemId",
                table: "Reactions",
                column: "ItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Responses_CollectionId",
                table: "Responses",
                column: "CollectionId");
